            ...
            <form method="GET" action="{{ route('payments.index') }}">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="search" id="search" value="{{ request('search') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Member name or receipt number">
                    </div>
                    ...
                    <div>
                        <label for="payment_type" class="block text-sm font-medium text-gray-700">Type</label>
