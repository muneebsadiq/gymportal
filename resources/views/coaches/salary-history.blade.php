...
@section('page-title', 'Salary History - ' . $coach->name)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-6">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Coach: <span class="font-medium text-gray-900">{{ $coach->name }}</span>
                </p>
            </div>
            <div class="mt-4 flex md:mt-0 md:ml-4 space-x-3">
                <a href="{{ route('coaches.show', $coach) }}" class="btn-secondary">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">{{ number_format($salaryPayments->sum('amount'), 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">{{ $salaryPayments->total() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-bold text-gray-900">
                                    @if($salaryPayments->first())
                                        {{ $salaryPayments->first()->expense_date->format('M d, Y') }}
                                    @else
                                        N/A
                                    @endif
                                </dd>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $payment->expense_date->format('M d, Y') }}
                            </td>
                    ...
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm font-bold text-gray-900 text-right">
                                {{ number_format($salaryPayments->sum('amount'), 2) }}
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">No salary payments have been recorded for this coach yet.</p>
                <div class="mt-6">
                    <a href="{{ route('coaches.show', $coach) }}" class="btn-primary">
                        Record Payment
                    </a>
                </div>
            </div>
