...
// Scroll to Due Fees Section
function scrollToDueFees() {
    const dueFeesSection = document.getElementById('dueFeesSection');
    if (dueFeesSection) {
        dueFeesSection.scrollIntoView({ 
            behavior: 'smooth', 
            block: 'start' 
        });
        // Add a highlight animation
        dueFeesSection.classList.add('ring-4', 'ring-red-400', 'ring-opacity-50');
        setTimeout(() => {
            dueFeesSection.classList.remove('ring-4', 'ring-red-400', 'ring-opacity-50');
        }, 2000);
    }
}
