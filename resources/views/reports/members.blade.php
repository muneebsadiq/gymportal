        ...
        <div class="bg-white shadow-sm rounded-lg p-6 mb-6 border border-gray-200">
            <form method="GET" action="{{ route('reports.members') }}">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                    ...
                    <div>
                        <label for="joined_from" class="block text-sm font-medium text-gray-700">Joined From</label>
                        <input type="date" name="joined_from" id="joined_from" value="{{ request('joined_from') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>
                    <div>
                        <label for="joined_to" class="block text-sm font-medium text-gray-700">Joined To</label>
                        <input type="date" name="joined_to" id="joined_to" value="{{ request('joined_to') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>
                    <div class="flex items-end space-x-2">
                        ...
                        <a href="{{ route('reports.members') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Clear
                        </a>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">PKR {{ number_format($members->sum(fn($m) => $m->payments->sum('amount')), 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
